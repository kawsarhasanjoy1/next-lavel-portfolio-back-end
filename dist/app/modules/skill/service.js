...
const createSkill = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield modal_1.SkillModal.create(payload);
    return result;
});
const getSkill = () => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield modal_1.SkillModal.find();
    return result;
});
const deleteSkill = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield modal_1.SkillModal.findByIdAndDelete(id);
    return result;
});
